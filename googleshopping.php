...
class BlockHomeFeatured extends Module
{
	private $_html = '';
	...
	function install()
	{
		if (!Configuration::updateValue('BLOCK_HOME_FEATURED_NBR', 8) || !parent::install() || !$this->registerHook('displayHome') || !$this->registerHook('header'))
			return false;
		return true;
	}
	...
	public function getContent()
	{
		...
		if (Tools::isSubmit('submitHomeFeatured'))
		{
			...
			if (!$nbr OR $nbr <= 0 OR !Validate::isInt($nbr))
				...
				Configuration::updateValue('BLOCK_HOME_FEATURED_NBR', (int)($nbr));
	...
	public function hookDisplayHome($params)
	{
		...
		$nb = (int)(Configuration::get('BLOCK_HOME_FEATURED_NBR'));
		...
		return $this->display(__FILE__, 'blockhomefeatured.tpl');
	}
}
